...
bool Dialog::GetWindowCheckBox(int theItem)
{
    auto aCheck = IsDlgButtonChecked(mHWND, theItem);

    return aCheck == BST_CHECKED;
}

void Dialog::SetWindowCheckBox(int theItem, bool theCheck)
{
    ::CheckDlgButton(GetDlgItem(theItem), 0, theCheck ? BST_CHECKED : BST_UNCHECKED);
}
