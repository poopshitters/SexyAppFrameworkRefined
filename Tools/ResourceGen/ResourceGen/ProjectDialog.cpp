...
void ProjectDialog::ReadEntryFile()
{
    ...
    while (!feof(aFile)) {
        char aName[512], anXML[512], aCode[512], aPrefix[512], aReturn[512], aUsePatoke[512];
        ...
        if (fgets(aUsePatoke, 511, aFile) == NULL)
            break;
        ...
        *aPtr = '\0';
        ...
        anEntry.mPatokeSystem = aUsePatoke == "true";
    }
...
void ProjectDialog::WriteEntryFile()
{
    ...
    for (EntryMap::iterator anItr = mEntryMap.begin(); anItr != mEntryMap.end(); ++anItr) {
        ...
        const char* aSTR = "false";
        if (anEntry.mPatokeSystem)
            aSTR = "true";
        fprintf(aFile, "%s\n", aSTR);
    }
...
void ProjectDialog::PopulateList()
{
    ...
    for (EntryMap::iterator anItr = mEntryMap.begin(); anItr != mEntryMap.end(); ++anItr) {
        ...
        ListView_SetCheckState(mProjectList, anIndex, 4, anEntry.mPatokeSystem ? BST_CHECKED : BST_UNCHECKED);
    }
}
...
void ProjectDialog::OnGenerateProject()
{
    ...
    ResourceManager aMgr;
    aMgr.mUsingPatoke = ListView_GetCheckState(mProjectList, anIndex);
    ...
    case WM_COMMAND:
        ...
        case BN_CLICKED:
            ...
            case IDC_NEW_PROJECT:
                OnNewProject();
                return TRUE;
            case IDC_MODIFY_PROJECT:
                OnModifyProject();
                return TRUE;
            case IDC_GENERATE_PROJECT:
                OnGenerateProject();
                return TRUE;
            case IDC_DELETE_PROJECT:
                OnDeleteProject();
                return TRUE;
            case IDC_REPORT_UNUSED:
                OnReportUnused();
                return TRUE;
            }
            break;
