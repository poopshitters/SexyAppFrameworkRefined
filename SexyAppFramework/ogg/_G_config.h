...
typedef          int  _G_int32_t __attribute__((__mode__(_SI__)));
typedef unsigned int _G_uint32_t __attribute__((__mode__(_SI__)));
...
#ifndef _SIZE_TYPE__
#define _SIZE_TYPE__ unsigned int
#endif
typedef _SIZE_TYPE__ _G_size_t;
...
#if defined (__cplusplus) || defined (_STDC__)
#define _G_ARGS(ARGLIST) ARGLIST
#else
#define _G_ARGS(ARGLIST) ()
#endif
#if !defined (__GNUG__) || defined (_STRICT_ANSI__)
#define _G_NO_NRV
#endif
#if !defined (__GNUG__)
